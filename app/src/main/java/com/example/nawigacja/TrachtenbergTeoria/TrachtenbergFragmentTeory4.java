 ...
 */
public class TrachtenbergFragmentTeory4 extends Fragment {
    ...
    CardView cardView;
    CardView cardView1;
    public TrachtenbergFragmentTeory4() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_trachtenberg_fragment_teory4, container, false);
