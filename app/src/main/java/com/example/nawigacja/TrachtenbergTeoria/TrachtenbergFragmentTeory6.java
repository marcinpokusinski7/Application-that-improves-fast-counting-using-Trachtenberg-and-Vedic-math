 ...
 */
public class TrachtenbergFragmentTeory6 extends Fragment {
    ...
    CardView cardView;
    CardView cardView1;
    public TrachtenbergFragmentTeory6() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_trachtenberg_fragment_teory6, container, false);
