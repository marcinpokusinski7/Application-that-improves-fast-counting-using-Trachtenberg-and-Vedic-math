 ...
 */
public class TrachtenbergFragmentTeory7 extends Fragment {
    ...
    CardView cardView;
    CardView cardView1;
    public TrachtenbergFragmentTeory7() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_trachtenberg_fragment_teory7, container, false);
