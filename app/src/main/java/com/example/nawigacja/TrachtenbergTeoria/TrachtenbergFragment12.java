 ...
 */
public class TrachtenbergFragment12 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_trachtenberg_fragment12, container, false);
      ...
      /*  arrowBtn.setOnClickListener(new View.OnClickListener() {
        ...
        sprawdz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(wynik.getText().toString().equals( wynik.getText().toString())){
                    wynik.setText(Integer.toString(number*12));
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TrachtenbergFragmentTeory12 trachtenbergFragmentTeory12 = new TrachtenbergFragmentTeory12();
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                //transaction.setCustomAnimations(R.anim.enter_from_right, R.anim.exit_to_right, R.anim.enter_from_right, R.anim.exit_to_right);
                transaction.replace(R.id.fragment_container, trachtenbergFragmentTeory12);
