 ...
 */
public class TrachtenbergFragmentTeory2 extends Fragment {
    ...
    CardView cardView;
    CardView cardView1;
    public TrachtenbergFragmentTeory2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_trachtenberg_fragment_teory2, container, false);
