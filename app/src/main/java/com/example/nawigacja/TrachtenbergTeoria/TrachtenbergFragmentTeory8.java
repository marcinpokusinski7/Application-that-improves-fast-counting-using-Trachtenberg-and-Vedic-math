 ...
 */
public class TrachtenbergFragmentTeory8 extends Fragment {
    ...
    CardView cardView;
    CardView cardView1;
    public TrachtenbergFragmentTeory8() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_trachtenberg_fragment_teory8, container, false);
