 ...
 */
public class WedyjskaFragmentSubTeory extends Fragment {
    ...
    CardView cardView;
    CardView cardView1;
    public WedyjskaFragmentSubTeory() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_wedyjska_sub_teory, container, false);
