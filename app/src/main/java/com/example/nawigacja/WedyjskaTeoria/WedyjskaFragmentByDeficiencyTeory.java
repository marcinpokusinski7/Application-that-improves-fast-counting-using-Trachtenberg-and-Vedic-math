 ...
 */
public class WedyjskaFragmentByDeficiencyTeory extends Fragment {
    ...
    CardView cardView;
    CardView cardView1;
    public WedyjskaFragmentByDeficiencyTeory() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_wedyjska_bydeficiency_teory, container, false);
