 ...
 */
public class WedyjskaFragmentPFiveTeory extends Fragment {
    ...
    CardView cardView;
    CardView cardView1;
    public WedyjskaFragmentPFiveTeory() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_wedyjska_involution5_teory, container, false);
