...
public class Testall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //wed
        queList.add(new QuestionClassCompare("Wpisz poprawny wynik potęgi kwadratowej: " + inv + ("\u00B2"), "" + (inv * inv), 1));
        queList.add(new QuestionClassCompare("Wpisz poprawny wynik potęgi kwadratowej: " + number + ("\u00B2"), "" + (number * number), 1));
        queList.add(new QuestionClassCompare("Jaki jest poprawny wynik różnicy liczb: " + sub + "-" + random3, "" + (sub - random3), 1));
        queList.add(new QuestionClassCompare("Wpisz poprawny wynik iloczynu liczb: " + deficiency + "*" + deficiency1, "" + (deficiency * deficiency1), 1));
